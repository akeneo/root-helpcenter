...
## Term
Unless otherwise set forth in the applicable Purchase Order, such Purchase Order will have an Initial Term of three (3) years (the “Initial Term”) starting on the first day of the Initial Term set forth in the applicable Purchase Order (“Effective Date” or “Start Date”). Prior to the end of the Initial Term, the Parties agree to enter into renewal negotiations four (4) months from the anniversary date. If the Parties fail to enter into a renewal agreement, the Agreement will automatically expire unless explicitly extended by an instrument in writing signed by both Parties.
...
- **Severity Levels and Response times**  
  ...
  | -------------- | ----------- | ---------------------- | ----------------- |
  | Severity 1 | **Blocking Error.**<br>means a problem in the Subscription Services making total use of the Services or use of an essential functionality impossible. | 4 business hours | 1 business day |
  | Severity 2 | **Major Error.**<br>means a problem which does not prevent the use of the Subscription Services but involves limited or restricted use of one or more essential functionalities. | 4 business hours | 2 business days |
  | Severity 3 | **Minor Error.**<br>means any problem which is neither a Blocking nor a Major Error. | 4 business days | 4 business days |
